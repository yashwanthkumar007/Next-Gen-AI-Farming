...
import 'animate.css';
import '../styles/AdminTransactionList.css';
...
const AdminTransactionList = () => {
  ...
  return (
    <div className="admin-tx-bg animate__animated animate__fadeIn">
      <div className="container py-5">
        <h4 className="mb-4 text-success black-text">💰 Transaction History (Admin View)</h4>
        ...
        {loading ? (
          ...
          <div className="table-responsive">
            <table className="table table-bordered table-hover shadow-sm admin-tx-table">
