...
const CardPayment = () => {
  ...
  if (!crop) return <div className="text-center mt-5 text-success">Loading crop info...</div>;

  const total = quantity * parseFloat(crop.price);

  return (
    <div className="payment-background d-flex align-items-center justify-content-center vh-100">
      <div className="glass-card animate__animated animate__fadeInUp">
        ...
        <h5 className="mt-3 text-success">Total: ₹{total}</h5>
