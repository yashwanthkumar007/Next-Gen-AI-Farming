...
import 'animate.css';
import '../styles/LeafColorChecker.css';
    ...
    <div className="leaf-checker-bg">
      <div className="glass-card animate__animated animate__fadeIn">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            <div className="d-flex gap-3 flex-wrap">
              {[1, 2, 3, 4, 5].map((shade) => (
                <button
                  key={shade}
                  type="button"
                  className={`rounded-circle shade-button ${selectedShade === shade ? 'selected' : ''}`}
          ...
          <button className="btn btn-outline-darkgreen mt-3" type="submit" disabled={!selectedShade || !crop || loading}>
